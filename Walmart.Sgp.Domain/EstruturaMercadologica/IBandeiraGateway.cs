...
{
    /// <summary>
    /// Interface para gateway de CWIDomain.
    /// </summary>
    public interface IBandeiraGateway : IDataGateway<Bandeira>
    {
        /// <summary>
        ...
        IEnumerable<BandeiraResumo> ObterPorUsuarioESistema(int idUsuario, int? idSistema, int? idFormato, int? idRegiaoAdministrativa);
        ...
        Bandeira ObterPorIdLoja(int idLoja);
    }
}
