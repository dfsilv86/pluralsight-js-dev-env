...
{
    /// <summary>
    /// Define a interface de um serviço de parâmetro de fornecedor.
    /// </summary>
    public interface IFornecedorParametroService : IDomainService<FornecedorParametro>
    {
        /// <summary>
        ...
        bool PossuiVendorVinculado(long cdItem, long cdSistema);
        ...
        bool EstaInativoOuExcluido(long cdItem, long cdSistema);
    }
}
