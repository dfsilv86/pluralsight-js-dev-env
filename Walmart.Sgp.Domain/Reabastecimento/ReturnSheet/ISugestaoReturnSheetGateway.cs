...
{
    /// <summary>
    /// Interface do SugestaoReturnSheetGateway
    /// </summary>
    public interface ISugestaoReturnSheetGateway : IDataGateway<SugestaoReturnSheet>
    {
        /// <summary>
        ...
        bool PossuiReturnsVigentesQuantidadesVazias(int idUsuario, int idPapel, int idLoja);
    }
}
