...
namespace Walmart.Sgp.Domain.EstruturaMercadologia
{ 
    /// <summary>
    ...
    /// <summary>
        /// Os status de uma bandeira. de inativo ("I").
        /// </summary>
        [SuppressMessage("Microsoft.Security", "CA2104:DoNotDeclareReadOnlyMutableReferenceTypes")]
        public static readonly BandeiraStatus Inativo = new BandeiraStatus("I");
