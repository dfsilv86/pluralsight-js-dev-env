...
{
    /// <summary>
    /// Define a interface para serviço de cadastro de nota fiscal.
    /// </summary>
    public interface INotaFiscalService
    {
        ...
        IEnumerable<NotaFiscalConsolidado> PesquisarUltimasEntradasPorFiltros(long idItemDetalhe, int idLoja, DateTime dtSolicitacao, Paging paging);
        ...
        void CorrigirCustos(IEnumerable<CustoNotaFiscal> custos);
    }
}
