...
namespace Walmart.Sgp.Domain.UnitTests.Reabastecimento.Specs.CargaMassiva
{
    [TestFixture]
    [Category("Domain")]
    public class ItemSaidaNaoPodeSerTransferenciaSpecTest
    {
        [Test]
        public void IsSatisfiedBy_ItemSaidaMTR_False()
        {
            ...
            var target = new ItemSaidaNaoPodeSerTransferenciaSpec((q, w) => { return id; }, 1);
        ...
        [Test]
        public void IsSatisfiedBy_ItemSaidaNaoMTR_True()
        {
            var vinculos = new List<RelacaoItemLojaCDVinculo>()
            {
                new RelacaoItemLojaCDVinculo()
