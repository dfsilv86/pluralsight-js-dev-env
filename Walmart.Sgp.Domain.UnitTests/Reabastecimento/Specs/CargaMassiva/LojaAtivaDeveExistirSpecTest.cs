...
namespace Walmart.Sgp.Domain.UnitTests.Reabastecimento.Specs.CargaMassiva
{
    [TestFixture]
    [Category("Domain")]
    public class LojaAtivaDeveExistirSpecTest
    {
        [Test]
        public void IsSatisfiedBy_LojaExistente_True()
        {
            ...
            var target = new LojaAtivaDeveExistirSpec((q, w) => { return true; }, 1);
        ...
        [Test]
        public void IsSatisfiedBy_LojaInexistente_False()
        {
            var vinculos = new List<RelacaoItemLojaCDVinculo>()
            {
                new RelacaoItemLojaCDVinculo()
            ...
            var target = new LojaAtivaDeveExistirSpec((q, w) => { return false; }, 1);
            var actual = target.IsSatisfiedBy(vinculos);
