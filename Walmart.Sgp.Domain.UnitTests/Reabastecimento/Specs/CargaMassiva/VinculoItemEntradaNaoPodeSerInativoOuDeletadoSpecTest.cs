...
namespace Walmart.Sgp.Domain.UnitTests.Reabastecimento.Specs.CargaMassiva
{
    [TestFixture]
    [Category("Domain")]
    public class VinculoItemEntradaNaoPodeSerInativoOuDeletadoSpecTest
    {
        [Test]
        public void IsSatisfiedBy_VinculoItemEntradaDeletado_False()
        {
            ...
            var target = new VinculoItemEntradaNaoPodeSerInativoOuDeletadoSpec((q, w) => { return id; }, 1);
        ...
        [Test]
        public void IsSatisfiedBy_VinculoItemEntradaAtivo_True()
        {
            var vinculos = new List<RelacaoItemLojaCDVinculo>()
            {
                new RelacaoItemLojaCDVinculo()
