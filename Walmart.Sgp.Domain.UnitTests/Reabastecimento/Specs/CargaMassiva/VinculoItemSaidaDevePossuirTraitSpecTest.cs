...
namespace Walmart.Sgp.Domain.UnitTests.Reabastecimento.Specs.CargaMassiva
{
    [TestFixture]
    [Category("Domain")]
    public class VinculoItemSaidaDevePossuirTraitSpecTest
    {
        [Test]
        public void IsSatisfiedBy_VinculoItemSaidaComTrait_True()
        {
            ...
            var target = new VinculoItemSaidaDevePossuirTraitSpec((q, w, e) => { return true; }, 1);
        ...
        [Test]
        public void IsSatisfiedBy_VinculoItemSaidaSemTrait_False()
        {
            var vinculos = new List<RelacaoItemLojaCDVinculo>()
            {
                new RelacaoItemLojaCDVinculo()
            ...
            var target = new VinculoItemSaidaDevePossuirTraitSpec((q, w, e) => { return false; }, 1);
            var actual = target.IsSatisfiedBy(vinculos);
