...
-- INICIO: manter sincronizado com Estoque.ObterOrigensItem.sql e Estoque.ObterUltimoCustoDoItemNaLoja.sql
...
-- FIM: manter sincronizado com Estoque.ObterOrigensItem.sql e Estoque.ObterUltimoCustoDoItemNaLoja.sql

), ObterOsCincoUltimosRecebimentosDoItemPorLoja AS (

	SELECT TOP 5 NF.IDNotaFiscal
	     , NF.dtRecebimento
