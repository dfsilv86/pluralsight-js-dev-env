...
.controller('UibDatepickerController', ['$scope', '$attrs', '$parse', '$interpolate', '$locale', '$log', 'dateFilter', 'uibDatepickerConfig', '$datepickerSuppressError', 'uibDateParser',
  ...
  this.init = function(ngModelCtrl_) {
    ...
    if (ngModelCtrl.$modelValue) {
        var a = datepickerConfig;
        this.activeDate = angular.isDate(ngModelCtrl.$modelValue)
            ? ngModelCtrl.$modelValue
            : moment(ngModelCtrl.$modelValue, moment.localeData()._longDateFormat.L).toDate()
    }
...
angular.module("uib/template/datepicker/popup.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("uib/template/datepicker/popup.html",
    "<div>\n" +
    "<div class=\"select2-drop-mask\" ng-if=\"isOpen\" ng-click=\"close()\"> </div>" +
